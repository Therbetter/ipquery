...
public class CreateSecretKey {
  ...
  /**用公钥加密*/
     ...
     * 使用私钥进行加密
     */
    public static byte[] encryptByPrivateKey(byte[] plainText,String privateKeyStr)throws Exception{
     ...
     * 使用公钥进行解密
     */
    public static byte[] decryptByPublicKey(byte[] encryptText,String publicKeyStr)throws Exception{
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("测试可行性-------------------公钥加密、私钥解密");
            ...
            System.out.println("测试可行性-------------------私钥加密、公钥解密");
            System.out.println("明文2======="+input);

            cipherText = encryptByPrivateKey(input.getBytes(),privateKey);
            //加密后的东西
            System.out.println("密文2======="+new String(cipherText));
            //开始解密
            byte[] plainText2 = decryptByPublicKey(cipherText,publicKey);
            System.out.println("解密后明文===== " + new String(plainText2));
